...
class Cube(object):
    ...
    def draw(self, surface, eyes=False):
        ...
        pygame.draw.rect(surface, self.color, (row * distance + 1, column * distance + 1, distance - 2, distance - 2))
        if eyes:
            center = distance // 2
            radius = 3
            circle_middle = (row * distance + center - radius, column * distance + 8)
